...
export const LiveUpdates = (): ReactElement => {
  ...
  useEffect(() => {
    setUpdates([
      ...
      {
        message:
          "Thanks for participating! Check your email or the WhatsApp group for the link to" +
          "upload your photos and videos to our shared folder.",
        timestamp: "2025-07-21T09:44:12-04:00",
        id: "4",
      },
    ]);
