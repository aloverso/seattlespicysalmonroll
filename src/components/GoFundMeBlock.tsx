  ...
  return (
    <>
      ...
      <a href={GOFUNDME_LINK} className="text-black button bg-teal pad hover-light-teal">
        Find us on GoFundMe
        <img src="/icons/external.svg" alt="" className="mls"
      ...
      <p>With our fundraising efforts, we will be able to offer participants: bottles of water,
        electrolytes powder or drinks, snacks, first aid kits, sunscreen, and event merch.</p>
    </>
  );
};
