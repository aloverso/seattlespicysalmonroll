      ...
      <main className="container mtxl">
        ...
        <div className="col-md-8">
          ...
          <FaqBlock
            ...
            a={
              <>
                We ask that all skaters use protective equipment: helmets, elbow pads, kneepads, and
                wrist guards. Additionally, for nighttime skates, you need to bring a form of light
                - the more the better. Headlamps, blinking lights, reflective clothing or
          ...
          <FaqBlock
            ...
            a={
              <>
                ...
                rides in or upon or by any means a coaster, skateboard, toy vehicle, or any similar
                device. However, a person may walk while wearing skates or carry a skateboard while
                on or in a transit vehicle or in or at a transit station if that conduct is not
                otherwise prohibited by law.&quot;
                <br />
                <br />
                In summary: if you are very careful to &quot;walk&quot; and not &quot;skate&quot;
                then it is legal to wear skates on King County metro, including buses and the light
                rail; otherwise you may be subject to a fine. We cannot endorse any particular
                behavior, you may choose behavior at your own risk.
              </>
            }
          />
        </div>
