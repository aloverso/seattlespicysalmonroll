      ...
      <main className="container mtxl">
        ...
        <div className="col-md-8">
          ...
          <FaqBlock
            ...
            a={
              <p>
                ...
                <a
                  href="https://www.facebook.com/story.php?story_fbid=390964204008435&id=135066862931505"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Seattle Distance Skating Club Guidebook
                </a>
                &nbsp;can offer guidance to the range and scope of different skates, according to
                spice level.
              </p>
            }
          />
          ...
          <FaqBlock
            ...
            a={
              <>
                ...
                <p>
                  <b>Pike Place Market</b>
                </p>
                <p>
                  <i>Note: You’ll need to skate (or walk) down a hill on your way out.</i>
                </p>
                <ul>
                  <li>
                    <a href="https://greentortoise.net/" target="_blank" rel="noopener noreferrer">
                      Green Tortoise Hostel
                    </a>
                  </li>
                  <li>
                    <a href="https://www.statehotel.com/" target="_blank" rel="noopener noreferrer">
                      The State Hotel
                    </a>
                  </li>
                </ul>
                <p>
                  <b>International District</b>
                </p>
                <ul>
                  <li>
                    <a
                      href="https://www.americanhotelseattle.com/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      The American Hostel
                    </a>
                    &nbsp;&mdash; a flat terrain option located at sea level.
                  </li>
                </ul>

                <p>
                  Aside from the Pike Place Market being a slight hill, all three locations have
                  easy access to the route start locations.
                </p>
              </>
            }
          />
          ...
          <FaqBlock
            ...
            a={
              <p>
                Each skate will be rated on a <b>1&ndash;5 {SPICE} spice scale</b> for skaters to
                assess against their own skill level and what they can expect from each route. In
                general, skaters should be able to stride, turn, and perform at least one basic
                stop. All skates will have regular rest stops to regroup, refuel, hydrate, and
                recover. Additionally, each skate will have a leader to ensure no one gets left
                behind or lost on the route.
              </p>
            }
          />
